...
var Shift = React.createClass({displayName: "Shift",
    ...
    render: function() {
            ...
            var fastLinksList =
              React.createElement("div", {id: "react-shift-fast-links"}, 
                Object.keys(fastLinks).map(function(i, v) {
                  return React.createElement("a", {key: "fastLink" + i, className: "react-shift-fast-link", href: "#", onClick: self.setPage.bind(null, fastLinks[i])}, Object.keys(fastLinks)[v]);
                })
              )
          } else {
            var fastLinksList;
      ...
      return (
        React.createElement("div", {key: "react-shift", id: "react-shift-wrapper", onWheelCapture: this.handleWheel, onTouchMove: this.handleTouch}, 
...
},{"./components/arrow.jsx":1,"react/addons":3}],176:[function(require,module,exports){
var React = require('react/addons'),
...
React.render(
  React.createElement(Shift, {arrowLabels: arrowLabels, fastLinks: fastLinks, transitions: true}, 
...
},{"./react-shift.jsx":175,"react/addons":3}]},{},[176]);
